...
const CardAcademicProjs: React.FC<CardServicoProps> = ({
  ...
  return (
    <div className="flex flex-col w-full max-w-[350px] h-auto bg-white shadow-[0_0px_30px_rgba(162,166,188,0.25)] rounded-lg px-3 py-4 ml-[32px] transition-shadow duration-300 hover:shadow-[0_0px_30px_rgba(78,95,181,0.44)] relative">
      ...
      <div className="py-2 mt-3 mb-10">
        ...
        <p className="text-gray-600 mt-4"><strong>Tipo de Projeto:</strong> {typeAP}</p>
      </div>
